...
parser.add_argument('--time_per_move', type=int, default=1)
parser.add_argument('--if_html', type=bool, default=True)
parser.add_argument('--turn_limit', type=int, default=196)
args = parser.parse_args()

TIME_PER_MOVE = args.time_per_move

USE_HTML = args.if_html
